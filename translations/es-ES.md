...
Este documento es una "chuleta" para el JavaScript que habitualmente encontrarás en proyectos modernos y ejemplos de código más actuales.

Esta guía no tiene la intención de enseñarte JavaScript desde cero, sino ayudar a desarrolladores con un conocimiento básico que tengan problemas para familiarizarse con código moderno (por ejemplo aprender React) debido a los conceptos del JavasScript usados.

Además, en algunos casos daré consejos personales que pueden ser debatibles, pero, en esos casos, tendré cuidado de avisar que es una recomendación personal.

> **Nota:** La mayoría de los conceptos presentados aquí proceden de actualizaciones del lenguaje JavaScript (ES2015, a menudo llamado ES6). Puedes encontrar nuevas características agregadas por dicha actualización [aquí](http://es6-features.org); es un trabajo estupendo.

### Recursos complementarios

Cuando tengas problemas para entender un concepto, te sugiero que intentes hallar la respuesta en una de las siguientes fuentes:
...
- [Google](https://www.google.com/) para encontrar un blog o recursos específicos
...
- [Modern JavaScript cheatsheet](#modern-javascript-cheatsheet)
  * [Introducción](#introduction)
    ...
    + [Recursos complementarios](#complementary-resources)
  * [Tabla de contenidos](#table-of-contents)
  * [Nociones](#notions)
    + [Declaración de variables: var, const, let](#variable-declaration-var-const-let)
      - [Breve explicación](#short-explanation)
      - [Código de ejemplo](#sample-code)
      - [Explicación detallada](#detailed-explanation)
      - [Recursos externos](#external-resource)
    + [Funciones flecha](#-arrow-function)
      - [Código de ejemplo](#sample-code-1)
      - [Explicación detallada](#detailed-explanation-1)
        * [Brevedad](#concision)
        * [Referencia *this*](#this-reference)
      - [Recursos útiles](#useful-resources)
    + [Valor por defecto de un parámetro de una función](#function-default-parameter-value)
      - [Recursos externos](#external-resource-1)
    + [Desestructurando objetos y matrices](#destructuring-objects-and-arrays)
      - [Explicación con código de ejemplo](#explanation-with-sample-code)
      - [Recursos útiles](#useful-resources-1)
    + [Métodos de matrices - map / filter / reduce](#array-methods---map--filter--reduce)
      - [Código de ejemplo](#sample-code-2)
      - [Explicación](#explanation)
        * [Array.prototype.map()](#arrayprototypemap)
        * [Array.prototype.filter()](#arrayprototypefilter)
        * [Array.prototype.reduce()](#arrayprototypereduce)
      - [Recursos externos](#external-resource)
    + [Operador de extensión "..."](#spread-operator-)
      - [Código de ejemplo](#sample-code-3)
      - [Explicación](#explanation-1)
        * [en iterables (like arrays)](#in-iterables-like-arrays)
        * [Parámetro resto en una funcción](#function-rest-parameter)
        * [Extensión de las propiedades de un objeto](#object-properties-spreading)
      - [Recursos externos](#external-resources)
    + [Abreviación de propiedades de objectos](#object-property-shorthand)
      - [Explicación](#explanation-2)
      - [Recursos externos](#external-resources-1)
    + [Promesas](#promises)
      - [Código de ejemplo](#sample-code-4)
      - [Explicación](#explanation-3)
        * [Crear la promesa](#create-the-promise)
        * [Uso de manejadores de promesas](#promise-handlers-usage)
      - [Resursos externos](#external-resources)
    + [Plantilla de literales](#template-literals)
      - [Código de ejemplo](#sample-code-5)
      - [Recursos externos](#external-resources-2)
    + [Etiquetas de plantillas de literales](#tagged-template-literals)
      - [Recursos externos](#external-resources-4)
    + [Imports / Exports](#imports--exports)
      - [Explicación con código de ejemplo](#explanation-with-sample-code-1)
        * [exports con nombre](#named-exports)
        * [import / export por defecto](#default-import--export)
      - [Recursos externos](#external-resources-3)
    + [*this* en JavaScript](#-javascript-this)
      - [Recursos externos](#external-resources-4)
    + [Class](#class)
      - [Ejemplos](#samples)
    ...
    + [Async Await](#async-await)
      ...
      - [Explicación con código de ejemplo](#explanation-with-sample-code-2)
